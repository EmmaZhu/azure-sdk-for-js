...
import { FOOTER_LENGTH, MESSAGE_HEADER_LENGTH, SEGMENT_HEADER_LENGTH, StructuredMessageEncoding } from "./StructuredMessageEncoding.js";
...
export async function structuredMessageEncoding(
    ...
    if (typeof (source) === 'function') {
        const encodingMessage = new StructuredMessageEncodingStream(source() as NodeJS.ReadableStream, content_length, {});
        return {
            body: encodingMessage,
            encoded_content_length: encodingMessage.messageLength(),
        };
